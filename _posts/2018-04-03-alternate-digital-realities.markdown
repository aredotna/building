...
Lastly, [BuyBlack](https://www.buyblack.io/) by [Angie Coleman](http://www.angiecoleman.me/) identifies black-owned alternatives to shopping sites entered into a browser's search bar. For example, if you visit sephora.com it’ll show a list of black-owned beauty supply stores.
