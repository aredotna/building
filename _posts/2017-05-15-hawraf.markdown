...
HAWRAF is run out of [NEW INC](http://www.newinc.org/), the incubator program at the New Museum. It’s still only months old. The three—four, including Pedro Sanches, who has been traveling—founded the studio with the intention of integrating what they term “Creative Accessibility” into their practice, making their operations as transparent as possible so others can learn from them. The first project under that initiative demonstrated the idea at its most condensed and intensive: [A-Z](http://az.hawraf.com/) was 26 straight hours of live-streamed creating, with one project completed every hour. 
